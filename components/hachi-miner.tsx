            ...
            <div style={{display:'flex',alignItems:'center',gap:14,marginBottom:12}}>
              ...
              <div style={{flex:1}}>
                ...
                {piggy.bonus>0&&<div style={{display:'flex',alignItems:'baseline',gap:8,marginBottom:8}}>
                  ...
                  <span style={{fontSize:10,fontWeight:800,color:'#fbbf24',background:'rgba(251,191,36,.15)',border:'1px solid rgba(251,191,36,.4)',borderRadius:6,padding:'2px 6px'}}>por tus licencias activas</span>
                </div>}
              </div>
            </div>
